...
## umap csv
df = pd.read_csv('umap(rm)_normal_validated.csv')
...
layout = html.Div([
    ...
    dbc.Row([html.H1(children='UMAP (Discrete: Normal) sample analysis (10 samples)', style={'textAlign': 'center'})], style={'padding': '10px'}),
    ...
    dbc.Col([
    dbc.Button(
            "5", id="example-button-5", className="me-2",  color="warning", href="/umap-nv-sample-5",
        ),
    dbc.Button(
            "10", id="example-button-10", className="me-2",  color="warning", href="/umap-nv-sample-10",
        ),
    dbc.Button(
            "20", id="example-button-20", className="me-2",  color="warning", href="/umap-nv-sample-20",
        ),
