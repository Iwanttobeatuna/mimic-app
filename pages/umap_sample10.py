...
layout = html.Div([
    ...
    dbc.Row([html.H1(children='UMAP sample analysis (10 samples)', style={'textAlign': 'center'})], style={'padding': '10px'}),
    ...
    ([
         dbc.Col([
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 10, "heart_rate", "heart_rate"))], 
            ...
            dbc.Row([
               ...
               html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 10, "respiratory_rate", "respiratory_rate"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 10, "hematocrit", "hematocrit"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 10, "fraction_inspired_oxygen", "fraction_inspired_oxygen"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 10, "creatinine", "creatinine"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
               ...
               html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 10, "mean_blood_pressure", "mean_blood_pressure"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 10, "sodium", "sodium"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
        ...
        dbc.Col([
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 10, "heart_rate", "heart_rate"))], 
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
               ...
               html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 10, "respiratory_rate", "respiratory_rate"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 10, "hematocrit", "hematocrit"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 10, "fraction_inspired_oxygen", "fraction_inspired_oxygen"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 10, "creatinine", "creatinine"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
               ...
               html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 10, "mean_blood_pressure", "mean_blood_pressure"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 10, "sodium", "sodium"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
        ],width=4, sm=4, md=4, lg=4),
        ...
        dbc.Col([
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_3, df_umap_3_describe, 10, "heart_rate", "heart_rate"))], 
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
               ...
               html.Div([dcc.Graph(figure = sample_plot(df_umap_3, df_umap_3_describe, 10, "respiratory_rate", "respiratory_rate"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_3, df_umap_3_describe, 10, "hematocrit", "hematocrit"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_3, df_umap_3_describe, 10, "fraction_inspired_oxygen", "fraction_inspired_oxygen"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_3, df_umap_3_describe, 10, "creatinine", "creatinine"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
               ...
               html.Div([dcc.Graph(figure = sample_plot(df_umap_3, df_umap_3_describe, 10, "mean_blood_pressure", "mean_blood_pressure"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_3, df_umap_3_describe, 10, "sodium", "sodium"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
        ],width=4, sm=4, md=4, lg=4),
    ]),
