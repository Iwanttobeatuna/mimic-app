...
layout = html.Div([
    ...
    dbc.Row([html.H1(children='UMAP (Discrete: Normal) sample analysis (20 samples)', style={'textAlign': 'center'})], style={'padding': '10px'}),
    ...
    ([
         dbc.Col([
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 20, "heart_rate", "heart_rate"))], 
            ...
            dbc.Row([
               ...
               html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 20, "respiratory_rate", "respiratory_rate"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 20, "hematocrit", "hematocrit"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 20, "fraction_inspired_oxygen", "fraction_inspired_oxygen"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 20, "creatinine", "creatinine"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
               ...
               html.Div([dcc.Graph(figure = sample_plot(df_umap_1, df_umap_1_describe, 20, "mean_blood_pressure", "mean_blood_pressure"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
        ...
        dbc.Col([
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 20, "heart_rate", "heart_rate"))], 
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
               ...
               html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 20, "respiratory_rate", "respiratory_rate"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 20, "hematocrit", "hematocrit"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 20, "fraction_inspired_oxygen", "fraction_inspired_oxygen"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
                ...
                html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 20, "creatinine", "creatinine"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
            ...
            dbc.Row([
               ...
               html.Div([dcc.Graph(figure = sample_plot(df_umap_2, df_umap_2_describe, 20, "mean_blood_pressure", "mean_blood_pressure"))],
                style={'width': '100%', 'display': 'inline-block'})
            ]),
